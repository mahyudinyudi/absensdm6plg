                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SD MUHAMMADIYAH 6 PALEMBANG</h2>
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> Absensi Siswa SD MUHAMMADIYAH 6 PALEMBANG (<a href="index.php"> M.ABDUR ROHIM </a>
                | 2023)
            </div>
        </div>
    </footer>
