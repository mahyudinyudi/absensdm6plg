		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="dashboard.php" class="logo">
					<!-- <img src="../assets/img/logo.jpg" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SD MUHAMMADIYAH 6</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SD MUHAMMADIYAH 6 PALEMBANG (<a href="index.php">M.ABDUR ROHIM </a> | 2023)
					</div>				
				</div>
			</footer>
		</div>
