...
$tglTerakhir = date('t',strtotime($tglBulan));
 ...
 <table width="100%">
 	<tr>
	 <td>
 			<img src="../../../assets/img/logo.jpg" width="130">
 		</td>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSESNSI SISWA <br>
 					<small> SD MUHAMMADIYAH 6 PALEMBANG</small>
 				</h1>
 				<hr>
 				<em>
				 Jl. Jendral Sudirman Km. 4,5 Palembang Kelurahan Ario Kemuning Kabupaten / Kota,Palembang
Kecanmatan,Kemuning<br>
 				<b>Email : sdmuhammadiyah6.kemuning@yahoo.co.id Telp.0711-412034</b> 
 				</em>
...
<table width="100%" border="1" cellpadding="2" style="border-collapse: collapse;">
  <tr>
    ...
    <td colspan="<?=$tglTerakhir;?>" style="padding: 8px;">PERTEMUAN BULAN : <b style="text-transform: uppercase;"><?php echo namaBulan($bulan);?> <?php echo date('Y'); ?></b></td>
